...
describe('User Service', () => {
    ...
    test('getAll should return all users', () => {
        ...
        const expectedUsers = [
            {id: 1, name: 'John Doe', email: 'doe@gmail.com'},
    ...
    test('getById should return correct user', () => {
        ...
        const expectedUser = {id: 1, name: 'John Doe', email: 'doe@gmail.com'};
        expect(userService.getById(user.id)).toEqual(expectedUser);
    });
